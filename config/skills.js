...
module.exports = {
	...
	3: { // Berserker
		...
		3: {
			...
			0: {
				noInterrupt: [2, 5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21],
		...
		5: { // Dash 
			0: { fixedSpeed: true, noInterrupt: [3,10] } // 50100, 50200, 50300, 50400, 50500
		},
		6: { // Berserker Staggering Strike normal
			'*': { noRetry: true },
			0: {
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21],
			},
		...
		8: { // Fiery Rage 
			0: { fixedSpeed: true, noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21], } // 80100, 80200, 80300, 80400, 80500, 80600, 80700
		},
		9: { // Berserker Spirit Concentrate Cast
			0: {
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21],
			} // 90100, 90200, 90300, 90400
		},
		10: { // Cyclone 
			0: {
				overcharge: 365,
		...
		16: { // Berserker Piercing Shout Start
			0: {
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21],
			} // 160100, 160200, 160300, 160400, 160500, 160600, 160700
		},
		17: { // Berserker Berserk Amplifying Cast
			0: {
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21],
			} // 170100, 170200, 170300, 170400
		},
		...
		19: { // Berserker Tenacity Cast
			0: { fixedSpeed: true,
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21]
			 } // 190100, 190200, 190300, 190400, 190500
		},
		20: { // Berserker Murderous Vent Cast
			0: { fixedSpeed: true,
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21]
			 } // 200100, 200200, 200300, 200400
		},
		21: { // Bloodlust 
			0: { fixedSpeed: true,
				noInterrupt: [5, 7, 8, 9, 12, 14, 16, 17, 18, 19, 20, 21]
			 } // 210100, 210200, 210300, 210400
		},
	...
	6: { // Priest
		...
		17: { // Priest Aggro Release Cast
			...
			} // 170100, 170200, 170300, 170400, 170500, 170600
		},
		18: { // Heal Thyself 
