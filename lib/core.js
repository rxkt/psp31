...
// Module-level variable for skillsClient (preload merged skills at initialization)
...
module.exports = function SPCore(mod) {
	...
	mod.command.add('pspreloadconfig', () => {
		delete require.cache[require.resolve('../config/skills.json')]
		skillsClient = require('../config/skills.json')
		mod.command.message('Reloaded merged skills.json')
	})
